...
def execute_cmdline(argv):
    ...
    p = add_command(
        "create_mnist", "Create dataset for MNIST.", "create_mnist datasets/mnist ~/downloads/mnist"
    )
    ...
    p = add_command(
        "create_svhn", "Create dataset for SVHN.", "create_svhn datasets/svhn ~/downloads/svhn"
    )
    p.add_argument("tfrecord_dir", help="New dataset directory to be created")
    ...
    p.add_argument(
        "--max_images", help="Maximum number of images (default: none)", type=int, default=None
    )
